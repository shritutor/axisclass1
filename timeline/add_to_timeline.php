...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insertQuery = "INSERT INTO timeline (school_id, user_id, description, coverimage_path, is_private, created_at)
                    VALUES ('$schoolid', '$user_id', '$description', '$coverImagePath', '$isPrivate', NOW())";
