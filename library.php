                        ...
                        <div class="card timeline-header-css">
                            <div class="PostHeader row mt-3">
                                <div class="text-center">
                                    <div class="page-header-size">Library<button
                                            class="btn btn-primary d-inline textbook-add-button-css" type="button"
                                            fdprocessedid="tuo1aa" style="margin-bottom: 8px;">Add</button></div>
                                </div>
                            </div>
                            <div class="row mb-1">
                                ...
                                <div class="col-10 col-sm-10 col-md-6 col-lg-6 col-xl-6 searchcourse text-center"><input
                                        ...
                                        fdprocessedid="uxoeu"><button
                                        class="btn btn-primary notebooksearchbutton rounded-pill" type="button"
                                        fdprocessedid="663ef3"><svg aria-hidden="true" focusable="false"
                            ...
                            <div class="row textbook-search-menu-row-css mb-3">
                                <div class="col-xl-2 col-sm-2 textbook-search-mobile-view-css p-0 mr-1"><select
                                        class="form-select textbook-search-menu-css" aria-label="Default select example"
                                        name="syllabus_id" fdprocessedid="7yojj" style="padding: 0.375rem 0.75rem;">
                                        <option value="">Select Syllabus</option>
                                        <option value="640c2c7852e850370d033292">jujubi</option>
                                        <option value="640aad17a9314b0ada0cf402">ICSE</option>
                                        <option value="64095ece346838026c0b4eb2">SSC</option>
                                        <option value="64085e7372b0ac61750b4dc2">I B</option>
                                        <option value="64082d1829a0e1702b03b7e2">CBSE</option>
                                    </select></div>
                                <div class="col-xl-2 col-sm-2 textbook-search-mobile-view-css p-0 mr-1"><select
                                        class="form-select textbook-search-menu-css" aria-label="Default select example"
                                        name="class_id" fdprocessedid="piz2xc" style="padding: 0.375rem 0.75rem;">
                                        <option value="">Select Class</option>
                                    </select></div>
                                <div class="col-xl-2 col-sm-2 textbook-search-mobile-view-css p-0 mr-1"><select
                                        class="form-select textbook-search-menu-css" aria-label="Default select example"
                                        name="subject_id" fdprocessedid="6ov9z" style="padding: 0.375rem 0.75rem;">
                                        <option value="">Select Subject</option>
                                    </select></div>
                                <div class="col-xl-1 col-sm-3 textbook-search-mobile-view-css text-center"><button
                                        class="btn btn-primary mt-1 textbook-add-button-css " type="button"
                                        fdprocessedid="g0ek4n">Go</button></div>
                            </div>
                            <div class="row mt-2 mb-3">
                                ...
                                <div class="text-center col-10 col-sm-10 col-md-8 col-lg-8 col-xl-8"><button
                                        ...
                                        id="library" fdprocessedid="0k20tp">My Library</button><button
                                        class="btn btn-primary rounded-pill groupbutton m-1" type="button"
                                        id="sharedlibrary" fdprocessedid="biye1">Shared Library</button></div>
                                <div class="col-1 col-sm-1 col-md-2 col-lg-2 col-xl-2"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            <div>
                                <div class="row mt-3 mb-3">
                                    <div class="col">
                                        <div class="card card p-3 friendcard">
                                            <div class="text-right d-sm-none position-absolute ellipsisbutton">
                                                <li class="nav-item dropdown marker-remove-textbook-css d-inline m-2"><a
                                                        href="#" class="nav-link py-0 menu-css d-inline "
                                                        aria-expanded="false"><svg aria-hidden="true" focusable="false"
                                                            data-prefix="fas" data-icon="ellipsis-v"
                                                            class="svg-inline--fa fa-ellipsis-v fa-w-6 d-inline ellipsis"
                                                            role="img" xmlns="http://www.w3.org/2000/svg"
                                                            viewBox="0 0 192 512" id="">
                                                            <path fill="currentColor"
                                                                d="M96 184c39.8 0 72 32.2 72 72s-32.2 72-72 72-72-32.2-72-72 32.2-72 72-72zM24 80c0 39.8 32.2 72 72 72s72-32.2 72-72S135.8 8 96 8 24 40.2 24 80zm0 352c0 39.8 32.2 72 72 72s72-32.2 72-72-32.2-72-72-72-72 32.2-72 72z">
                                                            </path>
                                                        </svg></a>
                                                    <ul class="dropdown-menu pt-0 course-action-dropdown-menu-css m-2"
                                                        role="menu" aria-hidden="true" placement="bottom-end">
                                                        <li><a class="dropdown-item">Edit</a></li>
                                                        <li><a class="dropdown-item">Delete</a></li>
                                                        <li><a class="dropdown-item">View</a></li>
                                                        <li><a class="dropdown-item">Post On Timeline</a></li>
                                                    </ul>
                                                </li>
                                            </div>
                                            <div class="row d-flex align-items-center justify-content-sm-center">
                                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-2"><img
                                                        class="card-img img-fluid rounded course-image mx-auto d-flex"
                                                        src="https://api.tutorpark.in/storage/library/image/physics-1137804215737432.jpg">
                                                </div>
                                                <div
                                                    class="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-7 text-center text-sm-center text-md-center text-lg-center text-xl-start">
                                                    <div class="d-inline font-weight-bold card-title">physics</div>
                                                    <div class="d-sm-inline  d-none ml-3">
                                                        <li
                                                            class="nav-item dropdown marker-remove-textbook-css d-inline m-2">
                                                            <a href="#" class="nav-link py-0 menu-css d-inline "
                                                                aria-expanded="false"><svg aria-hidden="true"
                                                                    focusable="false" data-prefix="fas"
                                                                    data-icon="ellipsis-v"
                                                                    class="svg-inline--fa fa-ellipsis-v fa-w-6 course-buttonellipsis d-inline "
                                                                    role="img" xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 192 512" id="">
                                                                    <path fill="currentColor"
                                                                        d="M96 184c39.8 0 72 32.2 72 72s-32.2 72-72 72-72-32.2-72-72 32.2-72 72-72zM24 80c0 39.8 32.2 72 72 72s72-32.2 72-72S135.8 8 96 8 24 40.2 24 80zm0 352c0 39.8 32.2 72 72 72s72-32.2 72-72-32.2-72-72-72-72 32.2-72 72z">
                                                            ...
                                                            <ul class="dropdown-menu pt-0 pb-0 courses-dropdown-menu course-action-dropdown-menu-css m-2"
                                                                role="menu" aria-hidden="true" placement="bottom-end">
                                                                <li><a class="dropdown-item">Edit</a></li>
                                                                <li><a class="dropdown-item">Delete</a></li>
                                                                <li><a class="dropdown-item">View</a></li>
                                                    ...
                                                    <div class="medium-text">physics textbook</div>
                                                    <div class="normal-font"> | | </div>
                                                    <div class="mt-4 pb-1 comment-input-div ">
                                                        <div
                                                            class="mb-2 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                            <form action="#">
                                                                <div class="mt-3 ">
                                                                    <div>
                                                                        <div class="MuiFormControl-root"><label
                                                                                ...
                                                                                value="" fdprocessedid="ses28s"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="row mt-4">
                                                                    <div
                                                ...
                                                <div
                                                    class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 d-flex justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-center justify-content-xl-start">
                                                    <button
                                                        class="btn btn-primary btn rounded-circle m-1 roundshap-button"
                                                        type="button" fdprocessedid="gus0h"><svg aria-hidden="true"
                                                        ...
                                                        class="btn btn-primary btn rounded-circle m-1 roundshap-button"
                                                        type="button" fdprocessedid="8qm30c"><svg aria-hidden="true"
                                                            focusable="false" data-prefix="fas" data-icon="phone-alt"
                                                        ...
                                                        class="btn btn-primary btn rounded-circle m-1 roundshap-button"
                                                        type="button" fdprocessedid="iv5nsd"><svg aria-hidden="true"
                                                            focusable="false" data-prefix="fas" data-icon="share-alt"
                                                        ...
                                                        class="btn btn-primary btn rounded-circle m-1 roundshap-button"
                                                        type="button" fdprocessedid="oof0hh"><svg aria-hidden="true"
                                    ...
                                    <div class="col">
                                        <div class="card card p-3 friendcard">
                                            ...
                                            <div class="row d-flex align-items-center justify-content-sm-center">
                                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-2"><img
                                                        class="card-img img-fluid rounded course-image mx-auto d-flex"
                                                        src="https://api.tutorpark.in/storage/library/image/6th_class__social-250960240487743.jpg">
                                                </div>
                                                <div
                                                    class="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-7 text-center text-sm-center text-md-center text-lg-center text-xl-start">
                                                    <div class="d-inline font-weight-bold card-title">social</div>
                                                    <div class="d-sm-inline  d-none ml-3">
                                                        <li
                                                            class="nav-item dropdown marker-remove-textbook-css d-inline m-2">
                                                            <a href="#" class="nav-link py-0 menu-css d-inline "
                                                    ...
                                                    <div class="medium-text">Social Testbook</div>
                                                    <div class="normal-font"> | | </div>
                                                    <div class="mt-4 pb-1 comment-input-div ">
                                                        <div
                                                            class="mb-2 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                ...
                                                                <div class="mt-3 ">
                                                                    <div>
                                                                        <div class="MuiFormControl-root"><label
                                                                                ...
                                                                                label="Add Comment" variant="outlined"
                                                                                autocomplete="off" maxlength="255"
                                                                                value="" fdprocessedid="q4o37o"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="row mt-4">
                                                                    <div
                                                ...
                                                <div
                                                    ...
                                                    <button
                                                        class="btn btn-primary btn rounded-circle m-1 roundshap-button"
                                                        type="button" fdprocessedid="w87lcf"><svg aria-hidden="true"
                                                            focusable="false" data-prefix="fas" data-icon="paper-plane"
                                                            class="svg-inline--fa fa-paper-plane fa-w-16 " role="img"
                                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                            <path fill="currentColor"
                                                        ...
                                                        class="btn btn-primary btn rounded-circle m-1 roundshap-button"
                                                        type="button" fdprocessedid="uh41k"><svg aria-hidden="true"
                                                            focusable="false" data-prefix="fas" data-icon="phone-alt"
                                                            class="svg-inline--fa fa-phone-alt fa-w-16 " role="img"
                                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                            <path fill="currentColor"
                                                        ...
                                                        class="btn btn-primary btn rounded-circle m-1 roundshap-button"
                                                        type="button" fdprocessedid="mxyxzi"><svg aria-hidden="true"
                                                            focusable="false" data-prefix="fas" data-icon="share-alt"
                                                            class="svg-inline--fa fa-share-alt fa-w-14 " role="img"
                                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                                            <path fill="currentColor"
                                                        ...
                                                        class="btn btn-primary btn rounded-circle m-1 roundshap-button"
                                                        type="button" fdprocessedid="80xyhj"><svg aria-hidden="true"
                                                            focusable="false" data-prefix="fas" data-icon="comment-alt"
                                                            class="svg-inline--fa fa-comment-alt fa-w-16 " role="img"
                                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                            <path fill="currentColor"
