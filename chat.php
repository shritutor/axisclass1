    ...
    <div id="root">
        <div>
            ...
            <div class="wrapper d-flex flex-column bg-light" style="min-height: 51px;">
                ...
                <div class="wrapper d-flex flex-row bg-light p-0" style="min-height: 154px;">
                                        ...
                                        <div class="MuiTabs-scroller MuiTabs-fixed css-1anid1y"
                                            ...
                                            <div aria-label="lab API tabs example"
                                                class="MuiTabs-flexContainer css-k008qs" role="tablist"><button
                                                    ...
                                                    aria-controls="mui-p-84139-P-1" id="mui-p-84139-T-1"
                                                    style="width: 50%; font-weight: 600;">Direct Chat<span
                                                    ...
                                                    aria-controls="mui-p-84139-P-2" id="mui-p-84139-T-2"
                                                    style="width: 50%; font-weight: 600;">Group Chat<span
                                                        class="MuiTouchRipple-root css-w0pj6f"></span></button></div>
                                            <span class="MuiTabs-indicator css-ttwr4n"
                                                style="left: 0px; width: 197.359px; background: rgb(90, 85, 203); height: 3px; color: rgb(90, 85, 203);"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="MuiTabPanel-root chatlist-scrollbar-css css-19kzrtu" role="tabpanel"
                                    aria-labelledby="mui-p-84139-T-1" id="mui-p-84139-P-1"
                                    style="padding: 0px; height: 50px; overflow: hidden scroll;">
                                    <p class="mt-5 text-center">Not have any personal conversation yet.</p>
                                </div>
                                <div class="MuiTabPanel-root chatlist-scrollbar-css css-19kzrtu" role="tabpanel"
                                    style="padding: 0px; height: 50px; overflow: hidden scroll;"
                                    aria-labelledby="mui-p-84139-T-2" id="mui-p-84139-P-2" hidden=""></div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div>
                                    <div class="card friendcard d-flex justify-content-center"
                                        ...
                                        <div class="text-center"><img class="card-img"
                                            ...
                                            <p class="card-text" style="color: rgb(210, 210, 210);">Select a Chat
                                                conversation</p>
                                        </div>
                                    </div>
                                </div>
