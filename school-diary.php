                ...
                <div class="card schooldiary-header-css">
                    <div class="PostHeader row mt-3">
                        <div class="text-center">
                            <div class="page-header-size">School Diary</div>
                        </div>
                    </div>
                    <div class="row mt-2 mb-3 ">
                        ...
                        <div class="text-center col-10 col-sm-10 col-md-8 col-lg-8 col-xl-8"><button
                                class="btn btn-primary groupbutton-active m-1" type="button" id="MyDiary"
                                fdprocessedid="8e6ao">My Diary</button><button class="btn btn-primary groupbutton m-1"
                                type="button" id="SchoolDiaryList" fdprocessedid="txgz68">School Diary</button></div>
                    </div>
                </div>
            </div>
            <div>
                <div>
                    <div style="text-align: center; padding-top: 10%;">
                        <h4>School diary data not available...</h4>
                    </div>
                </div>
            </div>
        </div>
