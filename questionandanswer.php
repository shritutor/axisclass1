...
<body><noscript>You need to enable JavaScript to run this app.</noscript>
    <div id="root">
        ...
        <div class="sidebar sidebar-fixed" selfhiding="md">
            ...
            <div class="wrapper d-flex flex-column bg-light" style="min-height: 132px;">
                ...
                <div class="wrapper d-flex flex-row bg-light p-0" style="min-height: 132px;">
                    <div class="body-content-css" sm="12" md="12" lg="12" xl="12" xxl="12" xs="12">
                        <div class="container col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xs-12">
                            ...
                            <div class="tutorheader page-header-size">
                                <div class="card post-header-css ">
                                    <div class="postheader">
                                        <div class="mt-3">
                                            <div class="d-flex m-auto justify-content-center col-12">
                                                <p class="postsearchheader">Ask a Question<button
                                                        class="btn btn-primary d-inline textbook-add-button-css"
                                                        type="button" fdprocessedid="dfpqyxr">Add</button></p>
                                            </div>
                                        </div>
                                        <div class="row mt-1 mb-1 ">
                                            <div class="col-1 col-sm-1 col-md-3 col-lg-3 col-xl-3"></div>
                                            <div class="search text-center col-10 col-sm-10 col-md-6 col-lg-6 col-xl-6">
                                                <input type="text" class="form-control searchinput rounded-pill pr-5"
                                                    placeholder="Search for the Question" fdprocessedid="t7ino"><button
                                                    class="btn btn-primary searchbutton rounded-pill" type="button"
                                                    fdprocessedid="44tvpl"> <svg aria-hidden="true" focusable="false"
                                        ...
                                        <div
                                            class="row textbook-search-menu-row-css mt-2 mb-3 d-flex justify-content-center">
                                            <div
                                                class="textbook-search-mobile-view-css col-10 col-sm-10 col-md-2 col-lg-2 col-xl-2">
                                                <select class="form-select textbook-search-menu-css"
                                                    aria-label="Default select example" name="subject_id"
                                                    fdprocessedid="0nxb5k" style="padding: 0.375rem 0.75rem;">
                                                    <option value="">Select Subject</option>
                                                </select>
                                            </div>
                                            <div
                                                class="textbook-search-mobile-view-css p-0 col-3 col-sm-3 col-md-2 col-lg-2 col-xl-2 d-flex align-items-center justify-content-center">
                                                <button class="btn btn-primary mt-1 textbook-add-button-css "
                                                    type="button" fdprocessedid="lov9s5">Go</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div style="text-align: center; padding-top: 10%;">
                                <h4>Question &amp; Answer data not available...</h4>
                            </div>
                            </p>
                        </div>
                    </div>
