...
$query = "INSERT INTO schooldiary (title,school_id,user_id,subject_id, coverimage_path, pdf_path, is_private,is_classworkd_or_homework, description) 
          VALUES ('$title','$schoolid','$userid','$subject', '$coverImage', '$pdfFilePath', '$isprivate','$is_classworkd_or_homework', '$description')";
