...
<style>
    ...
    *[dir=rtl] .wrapper {
    ...
    .schooldiary-header-css {
        background-image: url(assets/images/SchoolDiary.d35a5417.jpg);
        height: auto;
        background-repeat: round;
        border-radius: 0px;
        border-top-left-radius: 0.5rem;
...
<body><noscript>You need to enable JavaScript to run this app.</noscript>
    <div id="root">
        <div>
            ...
            <div class="wrapper d-flex flex-column bg-light" style="min-height: 51px;">
                ...
                <div class="wrapper d-flex flex-row bg-light p-0" style="min-height: 240px;">
    <div class="body-content-css" sm="12" md="12" lg="12" xl="12" xxl="12" xs="12">
        <div class="container col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xs-12">
            <div class="mt-3">
                <div class="card schooldiary-header-css">
                    <div class="row mt-3 d-flex">
                        <div class="text-center col-12">
                            <div class="postsearchheader">Class Room</div>
                        </div>
                    </div>
                    <div class="row mb-3 d-flex justify-content-center">
                        <div class="col-1 col-sm-1 col-md-3 col-lg-3 col-xl-3"></div>
                        <div class="text-center position-relative col-10 col-sm-10 col-md-6 col-lg-6 col-xl-6"><input
                                type="text" class="form-control searchinput rounded-pill pr-5"
                                placeholder="Search Classroom" fdprocessedid="cuw25c"><button
                                class="btn btn-primary searchbutton position-absolute rounded-pill " type="button"
                                fdprocessedid="8ha96"> <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                    data-icon="search" class="svg-inline--fa fa-search fa-w-16 serchingicon" role="img"
            ...
            <div style="text-align: center; padding-top: 10%;">
                <h4>Class List data not available...</h4>
            </div>
            </p>
        </div>
    </div>
