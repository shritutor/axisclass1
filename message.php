    ...
    <div id="root">
        <div>
            ...
            <div class="wrapper d-flex flex-column bg-light" style="min-height: 51px;">
                ...
                <d<div class="wrapper d-flex flex-row bg-light p-0" style="min-height: 159px;">
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                        <div class="card friendcard">
                            <div class="d-flex justify-content-around p-3">
                                <div class="d-flex position-relative col-xs-11 col-sm-11 col-md-11 col-lg-11 col-xl-11">
                                    <input type="text" class="form-control d-inline rounded-pill search-chat-input"
                                        placeholder="Search">
                                    <div class="search-button-chat rounded-pill position-absolute"><svg
                                ...
                                <div class="ml-1 d-flex align-items-center justify-content-center position-relative col-xs-1 col-sm-1 col-md-1 col-lg-1 col-xl-1"
                                    style="color: rgb(90, 85, 203); align-items: center; cursor: pointer;"><svg
                                        class="MuiSvgIcon-root MuiSvgIcon-fontSizeLarge css-6flbmm" focusable="false"
                                        aria-hidden="true" viewBox="0 0 24 24" data-testid="AddCircleOutlinedIcon">
                                        <path
                                            d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5 11h-4v4h-2v-4H7v-2h4V7h2v4h4v2z">
                                        </path>
                                    </svg></div>
                            </div>
                            <div class="MuiBox-root css-w8dmq8">
                                <div class="MuiBox-root css-zwnehf">
                                    <div class="MuiTabs-root css-orq8zk">
                                        <div class="MuiTabs-scroller MuiTabs-fixed css-1anid1y"
                                            ...
                                            <div aria-label="lab API tabs example"
                                                class="MuiTabs-flexContainer css-k008qs" role="tablist"><button
                                                    class="MuiButtonBase-root MuiTab-root MuiTab-textColorPrimary Mui-selected message-chat-in-active css-1q2h7u5"
                                                    tabindex="0" type="button" role="tab" aria-selected="true"
                                                    aria-controls="mui-p-38680-P-1" id="mui-p-38680-T-1"
                                                    style="font-weight: 600;">Direct Message<span
                                                        class="MuiTouchRipple-root css-w0pj6f"></span></button><button
                                                    class="MuiButtonBase-root MuiTab-root MuiTab-textColorPrimary message-chat-in-active css-1q2h7u5"
                                                    tabindex="-1" type="button" role="tab" aria-selected="false"
                                                    aria-controls="mui-p-38680-P-2" id="mui-p-38680-T-2"
                                                    style="font-weight: 600;">Group Message<span
                                                        class="MuiTouchRipple-root css-w0pj6f"></span></button></div>
                                            <span class="MuiTabs-indicator css-ttwr4n"
                                                style="left: 0px; width: 163.625px; background: rgb(90, 85, 203); height: 3px; color: rgb(90, 85, 203);"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="MuiTabPanel-root chatlist-scrollbar-css css-19kzrtu" role="tabpanel"
                                    aria-labelledby="mui-p-38680-T-1" id="mui-p-38680-P-1"
                                    style="padding: 0px; height: 55px; overflow: hidden scroll;">
                                    <div class="message-user-profile directchat">
                                        <div class="row p-2" style="cursor: pointer;">
                                            <div class="col col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2"><img
                                                    class="card-img rounded-circle messageuser-image"
                                                    src="https://api.tutorpark.in/storage/images/user/male.jpg"></div>
                                            <div class="col col-xl-7 col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <div class="font-weight-bold message-chat-name-font-size">virat janka
                                                    (TP-SS000421)</div><text
                                                    class="message-font-size">rRL6h5tnnqMfsTqRYfSUzPeejGg5wONy</text>
                                            </div>
                                            <div class="col col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3 ">
                                                <div class="message-font-size">2mos ago</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="message-user-profile directchat">
                                        <div class="row p-2" style="cursor: pointer;">
                                            <div class="col col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2"><img
                                                    ...
                                                    src="https://api.tutorpark.in/storage/images/user/male.jpg"></div>
                                            <div class="col col-xl-7 col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <div class="font-weight-bold message-chat-name-font-size">tutorpark
                                                    school admin (TP-SA000417)</div><text class="message-font-size">Date
                                                    of Diary : 13-02-2023Class Work : cw
                                                    qwertyuiop[
                                                    asdfghjkl;'

                                                    dfghjkl;.'/
                                                    sxdfcvgbhnjmk,l.View Class Work AttachmentHome Work : hw'o
                                                    mfnjhfgbjhsb
                                                    sfhbhnbmb
                                                    bhgbhbn
                                                    kjfgnbhn
                                                    ...
                                                    Tomorrow Topics : vbjfbcbsghdfgdbmvnguirtnuig
                                                    '/;l/;k/</text>
                                            </div>
                                            <div class="col col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3 ">
                                                <div class="message-font-size">2mos ago</div>
                                    ...
                                    <div class="message-user-profile directchat">
                                        <div class="row p-2" style="cursor: pointer;">
                                            <div class="col col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2"><img
                                                    ...
                                                    src="https://api.tutorpark.in/storage/images/user/male.jpg"></div>
                                            <div class="col col-xl-7 col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <div class="font-weight-bold message-chat-name-font-size">raina janka
                                                    (TP-SS000418)</div><text class="message-font-size">Date of Diary :
                                                    02-02-2023Class Work : dvfghmjklView Class Work AttachmentHome Work
                                                    : j,yukgdfgghkkjView Home Work AttachmentTomorrow Topics :
                                                    fgbtyj6uitkyth\
                                                    453683</text>
                                            </div>
                                            <div class="col col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3 ">
                                                <div class="message-font-size">3mos ago</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="MuiTabPanel-root chatlist-scrollbar-css css-19kzrtu" hidden=""
                                    role="tabpanel" style="padding: 0px; height: 55px; overflow: hidden scroll;"
                                    aria-labelledby="mui-p-38680-T-2" id="mui-p-38680-P-2"></div>
                            </div>
                        </div>
                    </div>
                    <div class="conversation-mobile-view-css col col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12">
                        <div>
                            <div>
                                <div>
                                    <div class="card friendcard d-flex justify-content-center"
                                        style="min-height: 175px;">
                                        <div class="text-center"><img class="card-img"
                                                src="data:image/png;base64,"
                                                style="height: 150px; width: 150px;">
                                            <p class="card-text" style="color: rgb(210, 210, 210);">Select a Message
                                                conversation</p>
                                        </div>
                                    </div>
                                </div>
